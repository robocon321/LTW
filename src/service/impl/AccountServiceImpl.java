...
import dao.impl.AccountImplDAO;
import model.Account;
import model.Admin;
import service.AccountService;
import utils.DividePage;

public class AccountServiceImpl implements AccountService{
	AccountDAO dao = new AccountImplDAO();
	private int start = 0;
	private int size = 10;
	...
	public List<Account> findBetween(String search) {
		List<Account> list = dao.findBetween(search, start, size);
