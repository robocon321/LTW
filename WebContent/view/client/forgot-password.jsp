    ...
    <div class="wrapper">
        ...
        <div class="Lost-pass ptb-100 ptb-sm-60">
            <div class="container">
                ...
                <form class="password-forgot clearfix" action="/forgot-password" method="POST">
                    <fieldset>
                        <legend>Your Personal Details</legend>
                        <div class="form-group d-md-flex">
                            <label class="control-label col-md-2" for="uname"><span class="require">*</span>Enter your username here...</label>
                            <div class="col-md-10">
                            	<p style="color:red">${error}</p>
                                <input type="text" name="uname" class="form-control" id="uname" placeholder="Enter you username here...">
                            </div>
                        </div>
                    </fieldset>
