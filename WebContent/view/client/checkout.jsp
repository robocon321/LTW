            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        ...
                        <li class="active"><a href="checkout.html"><fmt:message key = "checkout"/></a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <form class="checkbox-form mb-sm-40" method="POST" action="/checkout">
                            <h3><fmt:message key = "billing_details"/></h3>
                            <p style="color:red">${error}</p>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="checkout-form-list mb-sm-30">
                                        <label><fmt:message key = "first_name"/> <span class="required">*</span></label>
                                        <input type="text" placeholder="" name="fname"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="checkout-form-list mb-30">
                                        <label><fmt:message key = "last_name"/> <span class="required">*</span></label>
                                        <input type="text" placeholder="" name="lname"/>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list mb-30">
                                        <label><fmt:message key = "address"/> <span class="required">*</span></label>
                                        <input type="text" placeholder="" name="address"/>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list mb-30">
                                        <label><fmt:message key = "email"/> <span class="required">*</span></label>
                                        <input type="email" placeholder="" name="email"/>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list mb-30">
                                        <label><fmt:message key = "phone"/>  <span class="required">*</span></label>
                            ...
                            <div class="your-order-table table-responsive">
                                <table>
									...
									<c:forEach items="${products}" var="item" varStatus="loop">
										<tr class="cart_item">
                                            <td class="product-name">
                                                ${item.name}<span class="product-quantity"> x ${cartInfo[loop.index].quantity}</span>
                                            </td>
                                            <td class="product-total">
                                                <span class="amount">đ <fmt:formatNumber value="${item.promotionPrice*cartInfo[loop.index].quantity}" maxFractionDigits = "3" type="number"/></span>
                                            </td>
                                        </tr>
	                                    <script>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="cart-vat">
                                            <th>Vat</th>
                                            <td><span class="vat amount">0</span></td>
                                        </tr>
