                        ...
                        <div class="col-lg-5 mb-all-40">
                            ...
                            <div class="tab-content">
                                <div id="thumb1" class="tab-pane fade show active">
                                    <a data-fancybox="images" href="${product.imageMain}"><img src="${product.imageMain}" alt="product-view"></a>
                                </div>
                                <c:forEach items="${images}" var="item" varStatus="loop">
	                                <div id="thumb${loop.index+2}" class="tab-pane fade">
	                                    <a data-fancybox="images" href="${item.imageUrlContent}"><img src="${item.imageUrlContent}" alt="product-view"></a>
	                                </div>                                	
                                </c:forEach>
                            </div>
                            ...
                            <div class="product-thumbnail mt-15">
                                <div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
                                    <a class="active" data-toggle="tab" href="#thumb1"><img src="${product.imageMain}" alt="product-thumbnail"></a>
                                    <c:forEach items="${images}" var="item" varStatus="loop">
	                                    <a data-toggle="tab" href="#thumb${loop.index+2}"><img src="${item.imageUrlContent}" alt="product-thumbnail"></a>                                    
                                    </c:forEach>
                                </div>
                            </div>
                            <!-- Thumbnail image end -->
                        ...
                        <div class="col-lg-7">
                            <div class="thubnail-desc fix">
                                ...
                                <div class="pro-price mtb-30">
                                    <p class="d-flex align-items-center"><span class="prev-price">đ<fmt:formatNumber value="${product.promotionPrice}" maxFractionDigits = "3" type="number"/></span><span class="price">đ<fmt:formatNumber value="${product.price}" maxFractionDigits = "3" type="number"/></span><span class="saving-price">save 8%</span></p>
                                </div>
                                ...
                                <div class="box-quantity d-flex hot-product2">
                                    ...
                                    <div class="pro-actions">
                                        <div class="actions-primary">
                                            <a href="javascript:void(0)" onclick="addToCart(${product.productId}, parseInt($('.quantity').val()))" title="" data-original-title="Add to Cart"> + Add To Cart</a>
                                        </div>
                                        <div class="actions-secondary">
                                            <a href="compare.html" title="" data-original-title="Compare"><i class="lnr lnr-sync"></i> <span>Add To Compare</span></a>
                                            <a href="javascript:void(0)" onclick="addToWishlist(${product.productId})" title="" data-original-title="WishList"><i class="lnr lnr-heart"></i> <span>Add to WishList</span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="pro-ref mt-20">
                                    <p><span class="in-stock"><i class="ion-checkmark-round"></i> IN STOCK: ${product.quantity}</span></p>
                                </div>
               ...
               <!-- Product Title End -->
                ...
                <div class="hot-deal-active owl-carousel">
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="${url}/img/products/17.jpg" alt="single-product">
                                <img class="secondary-img" src="${url}/img/products/18.jpg" alt="single-product">
                            </a>
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="${url}/img/products/19.jpg" alt="single-product">
                                <img class="secondary-img" src="${url}/img/products/20.jpg" alt="single-product">
                            </a>
                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                        </div>
                        <!-- Product Image End -->
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="${url}/img/products/21.jpg" alt="single-product">
                                <img class="secondary-img" src="${url}/img/products/22.jpg" alt="single-product">
                            </a>
                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                        </div>
                        <!-- Product Image End -->
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="${url}/img/products/22.jpg" alt="single-product">
                                <img class="secondary-img" src="${url}/img/products/23.jpg" alt="single-product">
                            </a>
                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                        </div>
                        <!-- Product Image End -->
