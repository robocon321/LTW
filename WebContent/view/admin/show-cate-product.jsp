  ...
  <jsp:include page = "./header/header.jsp" flush = "true" />
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-8">
            <button class="add-catalog"><a href="${pageContext.request.contextPath}/admin/cate/product/add">Thêm chuyên mục</a></button>
          </div>
                  ...
                  <c:forEach items="${cates}" var="item">
                      <tr>
        				...
        				<td>
        				 ...
        				 <td>
                         <button class="btn btn-danger"><a href="${pageContext.request.contextPath}/admin/cate/product/delete?id=${item.categoryId}">Xóa</a></button>
                         
                          <button class="btn btn-success"><a href="${pageContext.request.contextPath}/admin/cate/product/edit?id=${item.categoryId}">Sửa</a></button>
                        </td>
                     </tr>
                    </c:forEach>
                    </tbody>
          ...
          <c:url value="${pageContext.request.contextPath}/admin/cate/product/list?" var="myURL">
			<c:if test="${search != ''}">
