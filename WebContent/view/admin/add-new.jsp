          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
                <form enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/admin/new/add">
               
                  <div class="form-group">
                    <label for="input-1">Tiêu đề</label>
                    <input type="text" class="form-control" id="input-1" placeholder="Tiêu đề" name="title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="input-3" placeholder="Hình ảnh" name="new_image">
 				  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="input-16" placeholder="Lượt xem" name="view_count">
 				  </div>
