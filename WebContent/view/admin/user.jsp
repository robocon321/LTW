    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="row mt-3">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  ...
                  <c:forEach items="${accounts}" var="acc">
                      <tr> 
                        <td scope="row">${acc.userId}</td> 
                        <td>${acc.username}</td>
                        <td>${acc.firstName}</td>
                        <td>${acc.lastName}</td>               
        				 <td> 
                           <button class="btn btn-danger"><a href="${pageContext.request.contextPath}/admin/user/delete?userId=${acc.userId}">Xóa</a></button>
              
                          <button class="btn btn-success"><a href="${pageContext.request.contextPath}/admin/user/edit?userId=${acc.userId}">Sửa</a></button>
                        </td> 
                     </tr>
                    </c:forEach> 
                    </tbody> 
          ...
          <c:url value="${pageContext.request.contextPath}/admin/user/list?" var="myURL">
			<c:if test="${search != ''}">
