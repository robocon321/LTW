            ...
            <div class="card">
              <div class="card-body">
                ...
                <hr>
	                ...
	                <form action="${pageContext.request.contextPath}/admin/cate/new/edit" method="post">
	                  <div class="form-group">
	                    <input type="hidden" class="form-control" readonly id="input-1" placeholder="ID" name="id" value="${cate.newCategoryId}">
	                  </div>
	                  <div class="form-group">
